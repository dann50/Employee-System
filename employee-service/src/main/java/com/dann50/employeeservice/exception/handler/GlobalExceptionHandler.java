package com.dann50.employeeservice.exception.handler;

import com.dann50.employeeservice.exception.dto.ApiErrorDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDto> illegalArgument(IllegalArgumentException ex){
        ...
        ApiErrorDto dto = new ApiErrorDto(ex.getMessage(), status.value());
